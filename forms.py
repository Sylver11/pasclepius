...
from wtforms import StringField, TextField, SubmitField, validators, FieldList, SelectField, FormField, FloatField
...
class Treatment(FlaskForm):
    set = SelectField('Set', choices=[('mutual', 'Mutual'),('personal#1', 'Personal #1'),('personal#2', 'Personal #2'),])
...
class Patient(FlaskForm): 
    ...
    po = FloatField(u'PO', validators=[DataRequired(), Length(6)])
